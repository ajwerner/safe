...
%%%
\newcommand{\AUTHORS}{Yi-Hsien Lin, Wathsala Vithanage, Andrew Werner}
\newcommand{\TITLE}{SAFE: Simple and Secure Naming and Keysharing on Untrusted Cloud Infrastructure}
\newcommand{\KEYWORDS}{}
